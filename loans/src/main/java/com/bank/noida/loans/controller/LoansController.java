package com.bank.noida.loans.controller;
...
@Tag(
        name = "CRUD REST APIs for Loans in Bank of Noida",
        description = "CRUD REST APIs in Bank of Noida to CREATE, UPDATE, FETCH AND DELETE loan details"
)
@RestController
...
public class LoansController {
    ...
    @Operation(
            ...
            description = "REST API to create new loan inside Bank of Noida"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "201",
